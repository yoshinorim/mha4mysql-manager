...
masterha_master_switch --master_state=alive --interactive=0 --conf=mha_test_multi_online.cnf --new_master_host=127.0.0.1 --new_master_port=$S1P --orig_master_is_new_slave > switch.log 2>&1
fail_if_nonzero $0 $?
